...
const BaseInputText = ({ register, name, type = "text", placeholder, rules, error }: InputTextPropsType) => {
    return (
        <div className="flex flex-col">
            ...
            {error && <span className="absolute -bottom-1.5 right-3 px-2 bg-white text-xs text-red-500">Preencha este campo</span>}
        </div>
    )
}
